...
function bar5group(g1, g2, g3, g4, g5){
    ...
    height5 = hmax-h5.toFixed(2)+delta
    maxvalue = Math.ceil(Math.max(h1,h2,h3,h4, h5))
    divide = Math.ceil(maxvalue/5)
...
return '<svg width="200" height="81">\
	...
	<g class="x axis" transform="translate(0,64)">\
			<g class="tick" transform="translate(20,0)" style="opacity: 1;"><line y2="1" x2="0"></line>\
			<text dy=".71em" y="3" x="0" style="text-anchor: middle; color:#9e9e9e">$</text>\
		</g>\
			<g class="tick" transform="translate(55,0)" style="opacity: 1;"><line y2="1" x2="0"></line>\
			<text dy=".71em" y="3" x="0" style="text-anchor: middle;color:#9e9e9e">$$</text>\
		</g>\
			<g class="tick" transform="translate(90,0)" style="opacity: 1;"><line y2="1" x2="0"></line>\
			<text dy=".71em" y="3" x="0" style="text-anchor: middle;color:#9e9e9e">$$$</text>\
        </g>\
			<g class="tick" transform="translate(125,0)" style="opacity: 1;"><line y2="1" x2="0"></line>\
			<text dy=".71em" y="3" x="0" style="text-anchor: middle; color:#9e9e9e">$$$$</text>\
		</g>\
		...
		<rect class="bar2" id ="rcorners1" x="38" width="30"  y="'+height2 +'" height="'+h2.toFixed(2)+'"style="fill:#024bd4;"></rect>\
		<rect class="bar2" id ="rcorners1" x="73" width="30"  y="'+height3 +'" height="'+h3.toFixed(2)+'"style="fill:#024bd4;"></rect>\
		<rect class="bar2" id ="rcorners1" x="108" width="30"  y="'+height4+'" height="'+h4.toFixed(2)+'"style="fill:#024bd4;"></rect>\
        <rect class="bar2" id ="rcorners1" x="143" width="30"  y="'+height5+'" height="'+h5.toFixed(2)+'"style="fill:#024bd4;"></rect>\
	</g>\
    </g>\
		<text dy=".71em" x="20" style="text-anchor: middle; color:#9e9e9e; font-size: 11px; font-weight:200;" y="'+th1 +'">'+round1(g1)+'%</text>\
		<text dy=".71em" x="55" style="text-anchor: middle; color:#9e9e9e; font-size: 11px; font-weight:200;" y="'+th2 +'">'+round1(g2)+'%</text>\
		<text dy=".71em" x="90" style="text-anchor: middle; color:#9e9e9e; font-size: 11px; font-weight:200;" y="'+th3 +'">'+round1(g3)+'%</text>\
		<text dy=".71em" x="125" style="text-anchor: middle; color:#9e9e9e; font-size: 11px; font-weight:200;" y="'+th4+'">'+round1(g4)+'%</text>\
        <text dy=".71em" x="160" style="text-anchor: middle; color:#9e9e9e; font-size: 11px; font-weight:200;" y="'+th5+'">'+round1(g5)+'%</text>\
	</g>\
</svg>'
}
